...
module.exports.loop = function () {
    ...
    profiler.wrap(function() {
        ...
        _.forEach(Game.rooms, room => {
            ...
            var hostiles = room.find(FIND_HOSTILE_CREEPS);//_.filter(room.find(FIND_HOSTILE_CREEPS), c => c.owner.username !== 'Mordox' && (c.getActiveBodyparts(ATTACK).length > 0 || c.getActiveBodyparts(RANGED_ATTACK).length > 0 || c.getActiveBodyparts(HEAL).length > 0));
